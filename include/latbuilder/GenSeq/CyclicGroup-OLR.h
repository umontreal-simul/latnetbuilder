...
namespace LatBuilder { namespace GenSeq {
   ...
   template<>
  struct CyclicGroupTraversalTraits<CyclicGroupTraversal<Lattice::INTEGRATION>>{
  ...
  struct CyclicGroupTraits<CyclicGroup<Lattice::INTEGRATION,COMPRESS,TRAV,ORDER>>{
    typedef size_t size_type;
    typedef LatticeTraits<Lattice::INTEGRATION>::GenValue value_type;
    typedef LatticeTraits<Lattice::INTEGRATION>::Modulus Modulus;
  };
...
template <Compress COMPRESS ,
         class TRAV ,
         GroupOrder ORDER>
class CyclicGroup < Lattice::INTEGRATION, COMPRESS, TRAV, ORDER> :
   public Traversal::Policy<CyclicGroup<Lattice::INTEGRATION, COMPRESS, TRAV, ORDER>, TRAV> {

   typedef CyclicGroup<Lattice::INTEGRATION, COMPRESS, TRAV, ORDER> self_type;
...
public:
   ...
   CyclicGroup(
         const CyclicGroup<Lattice::INTEGRATION, COMPRESS, TRAV2, ORDER>& other,
   ...
   struct RebindTraversal {
      typedef CyclicGroup<Lattice::INTEGRATION, COMPRESS, TRAV2, ORDER> Type;
   };
    ...
    */
   CyclicGroup<Lattice::INTEGRATION, COMPRESS, TRAV, !ORDER> inverse() const
   { return CyclicGroup<Lattice::INTEGRATION, COMPRESS, TRAV, !ORDER>(*this); }
...
private:
   template <Lattice, LatBuilder::Compress, class, GroupOrder> friend class CyclicGroup;
    ...
    * inverse generator.
    */
   CyclicGroup(const CyclicGroup<Lattice::INTEGRATION, COMPRESS, TRAV, !ORDER>& group);
   friend class CyclicGroup<Lattice::INTEGRATION, COMPRESS, TRAV, !ORDER>;
...
template < Compress COMPRESS, class TRAV, GroupOrder ORDER>
typename CyclicGroup<Lattice::INTEGRATION,COMPRESS, TRAV, ORDER>::value_type 
CyclicGroup<Lattice::INTEGRATION,COMPRESS, TRAV, ORDER>::smallestGenerator(Modulus base, Level power, bool checkPrime) 
{
   if (base == 2) {
      return 5;
   }
...
template < Compress COMPRESS, class TRAV, GroupOrder ORDER>
CyclicGroup<Lattice::INTEGRATION, COMPRESS, TRAV, ORDER>::CyclicGroup(const CyclicGroup<Lattice::INTEGRATION, COMPRESS, TRAV, ORDER>& other, Level level):
...
template <Compress COMPRESS, class TRAV, GroupOrder ORDER>
CyclicGroup<Lattice::INTEGRATION, COMPRESS, TRAV, ORDER>::CyclicGroup(const CyclicGroup<Lattice::INTEGRATION, COMPRESS, TRAV, !ORDER>& other):
   TraversalPolicy(static_cast<const TraversalPolicy&>(other)),
   m_base(other.m_base),
   m_power(other.m_power),
   m_modulus(other.m_modulus),
...
template <Compress COMPRESS, class TRAV, GroupOrder ORDER>
CyclicGroup<Lattice::INTEGRATION, COMPRESS, TRAV, ORDER>::CyclicGroup(Modulus base, Level power, Traversal trav):
   TraversalPolicy(std::move(trav)),
   m_base(base),
   m_power(power)
{
...
template <Compress COMPRESS, class TRAV, GroupOrder ORDER>
auto CyclicGroup<Lattice::INTEGRATION, COMPRESS, TRAV, ORDER>::operator[](size_type i) const -> value_type
{
   if (i == 0)
      return 1;
