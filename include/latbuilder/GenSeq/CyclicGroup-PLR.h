...
namespace LatBuilder { namespace GenSeq {
  ...
  template<>
  struct CyclicGroupTraversalTraits<CyclicGroupTraversal<Lattice::POLYNOMIAL>>{
  ...
  struct CyclicGroupTraits<CyclicGroup<Lattice::POLYNOMIAL,COMPRESS,TRAV,ORDER>>{
    typedef size_t size_type;
    typedef LatticeTraits<Lattice::POLYNOMIAL>::GenValue value_type;
    typedef LatticeTraits<Lattice::POLYNOMIAL>::Modulus Modulus;
  };
...
template <Compress COMPRESS,
         class TRAV ,
         GroupOrder ORDER >
class CyclicGroup< Lattice::POLYNOMIAL, COMPRESS, TRAV, ORDER> :
   public Traversal::Policy<CyclicGroup<Lattice::POLYNOMIAL, COMPRESS, TRAV, ORDER>, TRAV> {

   typedef CyclicGroup<Lattice::POLYNOMIAL, COMPRESS, TRAV, ORDER> self_type;
...
public:
   ...
   CyclicGroup(
         const CyclicGroup<Lattice::POLYNOMIAL, COMPRESS, TRAV2, ORDER>& other,
   ...
   struct RebindTraversal {
      typedef CyclicGroup<Lattice::POLYNOMIAL, COMPRESS, TRAV2, ORDER> Type;
   };
    ...
    */
   CyclicGroup<Lattice::POLYNOMIAL, COMPRESS, TRAV, !ORDER> inverse() const
   { return CyclicGroup<Lattice::POLYNOMIAL,COMPRESS, TRAV, !ORDER>(*this); }
...
private:
    ...
    * inverse generator.
    */
   CyclicGroup(const CyclicGroup<Lattice::POLYNOMIAL, COMPRESS, TRAV, !ORDER>& group);
   friend class CyclicGroup<Lattice::POLYNOMIAL, COMPRESS, TRAV, !ORDER>;
...
template < Compress COMPRESS, class TRAV, GroupOrder ORDER>
typename CyclicGroup<Lattice::POLYNOMIAL,COMPRESS, TRAV, ORDER>::value_type 
CyclicGroup<Lattice::POLYNOMIAL,COMPRESS, TRAV, ORDER>::smallestGenerator(Modulus base, Level power, bool checkPrime)
{
   if (IsZero(base))
...
template < Compress COMPRESS, class TRAV, GroupOrder ORDER>
CyclicGroup<Lattice::POLYNOMIAL, COMPRESS, TRAV, ORDER>::CyclicGroup(const CyclicGroup<Lattice::POLYNOMIAL, COMPRESS, TRAV, ORDER>& other, Level level):
...
template <Compress COMPRESS, class TRAV, GroupOrder ORDER>
CyclicGroup<Lattice::POLYNOMIAL, COMPRESS, TRAV, ORDER>::CyclicGroup(const CyclicGroup<Lattice::POLYNOMIAL, COMPRESS, TRAV, !ORDER>& other):
   TraversalPolicy(static_cast<const TraversalPolicy&>(other)),
   m_base(other.m_base),
   m_power(other.m_power),
   m_modulus(other.m_modulus),
...
template <Compress COMPRESS, class TRAV, GroupOrder ORDER>
CyclicGroup<Lattice::POLYNOMIAL, COMPRESS, TRAV, ORDER>::CyclicGroup(Modulus base, Level power, Traversal trav):
   TraversalPolicy(std::move(trav)),
   m_base(base),
   m_power(power)
{
...
template <Compress COMPRESS, class TRAV, GroupOrder ORDER>
auto CyclicGroup<Lattice::POLYNOMIAL, COMPRESS, TRAV, ORDER>::operator[](size_type i) const -> value_type
{
