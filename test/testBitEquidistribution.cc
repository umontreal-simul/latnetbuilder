...
int main(int argc, const char *argv[])
{
    ...
    auto fig = std::make_unique<FigureOfMerit::BitEquidistribution<PointSetType::MULTILEVEL>>(1, std::numeric_limits<Real>::infinity(), std::numeric_limits<Real>::infinity(), MaxCombiner());
