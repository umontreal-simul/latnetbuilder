...
int main(int argc, const char *argv[])
{
    ...
    LatBuilder::SizeParam<LatBuilder::LatticeType::DIGITAL, LatBuilder::LatEmbed::EMBEDDED> param(2, m);
    std::function<Real (const RealVector&)> f_combine = combine;
    auto fig1 = std::make_unique<FigureOfMerit::CoordUniformFigureOfMerit<LatBuilder::Kernel::PAlphaPLR, LatBuilder::LatEmbed::EMBEDDED>>(std::move(weights1), m, param, kernel, f_combine);
