...
//    test(Storage<LatticeType::ORDINARY, EmbeddingType::UNILEVEL, Compress::NONE>(256), dim);
   
   test(Storage<LatticeType::POLYNOMIAL, EmbeddingType::UNILEVEL, Compress::SYMMETRIC>(PolynomialFromInt(115)), dim);
